...
export const ZooAiIcon: React.FC<{ className: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2a2.5 2.5 0 0 0-2.5 2.5V7h5V4.5A2.5 2.5 0 0 0 12 2z" />
        <path d="M12 22a2.5 2.5 0 0 1-2.5-2.5V17h5v2.5A2.5 2.5 0 0 1 12 22z" />
